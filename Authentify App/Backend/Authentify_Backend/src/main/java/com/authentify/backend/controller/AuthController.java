...
public class AuthController {
	...
	void verifyEmail(@RequestBody Map<String, Object> request, @CurrentSecurityContext(expression = "authentication?.name") String email) {
		...
		try {
			...
			pService.verifyOtp(email, request.get("otp").toString());
