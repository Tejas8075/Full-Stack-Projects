...
const ResetPassword = () => {
  ...
  const onSubmitEmail = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || err.message || "Unable to send OTP");
    } finally {
      setLoading(false);
    }
  };
  ...
  const onSubmitNewPassword = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || err.message || "Unable to reset password. Please try again later.");
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    ...
    >
      ...
      {/* Reset password card */}
      {!isEmailSent && (
        <div className="rounded-4 p-5 text-center bg-white shadow"
          style={{
            width: "100%",
            maxWidth: "400px",
          }}
      ...
      {/* New Password Form */}
      {isOtpSubmitted && isEmailSent && (
        <div className="rounded-4 p-4 text-center bg-white shadow"
